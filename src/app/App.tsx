...
const defaultBloodParameters: BloodParameter[] = [
  { id: 'hemoglobin', name: 'Hämoglobin', unit: 'g/l', normalRange: { min: 120, max: 160 }, color: '#3B82F6' },
  { id: 'erythrocytes', name: 'Erythrozyten', unit: '×10¹²/l', normalRange: { min: 3.5, max: 5.5 }, color: '#EF4444' },
  { id: 'leukocytes', name: 'Leukozyten', unit: '×10⁹/l', normalRange: { min: 4, max: 9 }, color: '#10B981' },
  { id: 'platelets', name: 'Thrombozyten', unit: '×10⁹/l', normalRange: { min: 180, max: 320 }, color: '#F59E0B' },
  { id: 'esr', name: 'BSG', unit: 'mm/h', normalRange: { min: 2, max: 15 }, color: '#8B5CF6' },
  { id: 'glucose', name: 'Glukose', unit: 'mmol/l', normalRange: { min: 3.3, max: 5.5 }, color: '#EC4899' },
  { id: 'cholesterol', name: 'Cholesterin', unit: 'mmol/l', normalRange: { min: 3, max: 5.2 }, color: '#14B8A6' },
];
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <div className="px-6 py-4">
        <h1 className="text-2xl font-semibold">Meine Analysen</h1>
      </div>
      ...
      <div className="px-6 py-4">
        <div className="bg-zinc-900 rounded-2xl p-4">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm text-zinc-400">Normalbereich</span>
